def set_config(args, custom_dataset="haha"):
    ...
    if args.load_different_model:
        ...
        sampledImgName = f"SampledNoGuidenceImgs{args.load_training_checkpoint}.png"
        sampledNoisyImgName = f"NoisyNoGuidenceImgs{args.load_training_checkpoint}.png"
        
    elif args.load_trained_model:
        training_load_weight = f"c{str(args.split_class[0])}_ckpt_{args.load_pretrain_checkpoint}_.pt"
        test_load_weight = f"c{str(args.split_class[0])}_ckpt_{args.load_pretrain_checkpoint}_.pt"
        sampledImgName = f"SampledNoGuidenceImgs{args.load_pretrain_checkpoint}.png"
        sampledNoisyImgName = f"NoisyNoGuidenceImgs{args.load_pretrain_checkpoint}.png"
    ...
    if custom_dataset == 'Imagenet':
        model_config = {
            ...
            "sampledNoisyImgName": sampledNoisyImgName,
            "sampledImgName": sampledImgName,
            "nrow": 8
        }
